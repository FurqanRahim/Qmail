...
const page = () => {
    return (
        <div className='bg-[#F0F0F2] py-10 flex flex-col gap-10'>
            ...
            <div className='text-[32px] text-[#2F206A] font-black text-center -ml-16 md:text-[64px] md:mt-12 md:-ml-12'>Login</div>
            <div className='text-[20px] font-bold pl-24 md:text-[24px] -ml-4 md:text-center md:-ml-36'>Sign in to your account</div>
            <div className='bg-white w-[380px] mx-auto shadow border-[#2F206A] rounded-md p-4 md:w-[500px] md:mt-8'>
                ...
                <div className='text-[16px] font-medium  p-2 flex flex-col gap-6 md:p-4'>
                    ...
                    <div className='pl-2 flex gap-1'>
                        New here? <div className='text-[#2F206A] font-bold cursor-pointer border-black border-b-1'>
